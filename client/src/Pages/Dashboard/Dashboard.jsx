...
const Dashboard = () => {
  ...
  const { authEmail, authRole, restricted } = useContext(GlobalContext);
          ...
          {!restricted ? (
            <div className="flex">
                          ...
                          <li>
                            <Link to="/dashboard?tab=admin-list">
                              <button
                                ...
                                onClick={() =>
                                  handleSectionChange("admin-list")
                                }
                              >
                                <svg
                                  className="shrink-0 w-5 h-5 mr-3 text-gray-500 transition duration-75 group-hover:text-gray-900"
              ...
              <main className="w-4/5 p-5">
                ...
                {authRole === "admin" && (
                  <Admin activeSection={activeSection} />
                )}
                {authRole === "buyer" && (
                  <Buyer activeSection={activeSection} />
                )}
                {(authRole === "buyer" || authRole === "seller") &&
